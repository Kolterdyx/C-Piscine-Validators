...
file00="../ex00/ft_putchar.c"
file01="../ex01/ft_print_alphabet.c"
file02="../ex02/ft_print_reverse_alphabet.c"
file03="../ex03/ft_print_numbers.c"
file04="../ex04/ft_is_negative.c"
file05="../ex05/ft_print_comb.c"
file06="../ex06/ft_print_comb2.c"
file07="../ex07/ft_putnbr.c"
file08="../ex08/ft_print_combn.c"
...
clear
echo -e "$GRN+-#########################################-+$RESET"
echo -e "$GRN| Bienvenido al validador del proyecto ${WHT}C 00${GRN} |$RESET"
echo -e "$GRN+-#########################################-+$RESET"
echo -e ""
