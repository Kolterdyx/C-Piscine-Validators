...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/23 08:10:06 by cigarcia          #+#    #+#             */
/*   Updated: 2022/03/23 09:27:40 by cigarcia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	size1 = 6;
	size2 = 7;
	printf(CYN "-- Comprobando el ejercicio ex08:\n" RESET);
	...
	printf(BLU "    Ejecutando línea " GRN "'ft_sort_int_tab(tab1, size1);'\n");
	ft_sort_int_tab(tab1, size1);
	printf(YEL "    tab1: " RESET "[%i, %i, %i, %i, %i, %i]\n", tab1[0], tab1[1], tab1[2], tab1[3], tab1[4], tab1[5]);
	printf(BLU "    Ejecutando línea " GRN "'ft_sort_int_tab(tab2, size2);'\n");
